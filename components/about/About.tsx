    ...
    <Flex id="about" direction="column" justify="center" pt="40" h="60rem" mt={["30rem", "30rem", "30rem", "0", "0"]}>
        <Center>
            <Flex gap={10} position="relative" direction={["column", "column", "column", "row", "row"]}>
                ...
                <Flex border="2px" boxShadow="2xl" borderColor="#C8A97E" borderBottomLeftRadius="3xl" borderBottomRightRadius="3xl" direction="column" bg="white" p="16" top={["30%", "30%", "30%", 20, 20]} left={[-6, -6, -6, 500, 500]} w={["full", "full", "23rem", "38rem", "38rem"]} position="absolute">
