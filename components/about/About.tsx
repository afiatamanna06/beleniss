    ...
    <Flex justify="center" h="40rem" mt={["20rem", "20rem", "20rem", "0", "0"]}>
        <Center>
            <Flex gap={10} position="relative" direction={["column", "column", "column", "row", "row"]}>
                ...
                <Flex border="2px" boxShadow="2xl" borderColor="#C8A97E" borderBottomLeftRadius="3xl" borderBottomRightRadius="3xl" direction="column" bg="white" p="16" top={[350, 350, 350, 20, 20]} left={[-10, -10, -10, 500, 500]} w={["25rem", "25rem", "25rem", "38rem", "38rem"]} position="absolute">
