...
function NavigationBar() {
  ...
  return (
    <Flex position="fixed" bg="rgba(0, 0, 0, .05)" fontFamily="'Poppins', sans-serif" zIndex={99} alignItems={["start", "start", "start", "center", "center"]} textShadow='2px 2px #9B4B15' backdropFilter="blur(10px)" color="white" p="4" h={ responsiveDisplay === "none" ? "min-content" : ["98vh", "98vh", "98vh", "min-content", "min-content"] } w={["93vw", "93vw", "93vw", "98vw"]} direction={["column", "column", "column", "row", "row"]} justify="space-between" mx="4" my="4">
